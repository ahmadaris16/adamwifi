<?php
// halaman_job_teknisi.php — Daftar Job Teknisi dengan Modern Date Picker (fix overflow + pretty date + equal buttons)
  ...
  <div class="topbar">
    <div class="topbar-content">
      ...
      <div class="actions">
        ...
        <a class="btn" href="tambah_job.php">+ Tambah Job</a>
      </div>
    </div>
  </div>
      ...
      <div class="card card-filter">
        <form method="get" class="filter" id="filterForm">
          <div class="filter-row">
            ...
            <a class="btn secondary" href="halaman_job_teknisi.php?from=<?=date('Y-m-01')?>&to=<?=date('Y-m-d')?>&tech=0">Reset</a>
          </div>
