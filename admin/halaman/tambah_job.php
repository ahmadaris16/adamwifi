<?php
// tambah_job.php — Form input Job Teknisi (AJAX) — UI modern seragam
...
<body>
  ...
  <div class="topbar">
    <div class="topbar-content">
      ...
      <div class="actions">
        <a class="btn secondary" href="halaman_job_teknisi.php">← Kembali</a>
    ...
    <div class="card">
      ...
      <form method="post" id="jobForm">
        ...
        <div class="button-group">
          ...
          <a class="btn secondary" href="halaman_job_teknisi.php">Batal</a>
        </div>
      </form>
    </div>
  </div>
  ...
  form.addEventListener('submit', async function(ev){
    ...
    try{
      ...
      if(json.ok){
        ...
        setTimeout(function(){
          location.href = json.redirect || 'halaman_job_teknisi.php';
        }, 1000);
      } else {
